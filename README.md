...
`dotfiles` in a less restricted path like `~/dotfiles`, avoids these privacy controls, and apps can freely follow the symlink without triggering System Policy denials.

### Agent OS

Agent OS is a specification driven development system for better planning and executing software development tasks with your AI agents.
